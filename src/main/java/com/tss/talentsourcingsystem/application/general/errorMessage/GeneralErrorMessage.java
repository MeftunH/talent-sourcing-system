...
public enum GeneralErrorMessage implements BaseErrorMessage {
    ...
    CONTACT_INFORMATION_TYPE_NOT_MATCH("Contact information type not match!","Please check the contact information type."),
    INTERNAL_SERVER_ERROR("Sorry about that...Internal server error!","Please try again later.");
